...
def simulate_n_steps(Px, Dx, Py, Dy, Pz, Dz, Pa, Da, env, current_target):
...
if __name__ == "__main__":
        ...
        if step >= 300:
            ...
            optimizer = BayesianOptimization(
                f=lambda Px, Dx, Py, Dy, Pz, Dz, Pa, Da: simulate_n_steps(
                    Px, Dx, Py, Dy, Pz, Dz, Pa, Da, env, current_target
                ),
                pbounds=bounds,
                verbose=0,
            ...
            # # 验证环境是否保持原样
            # print('101', compare_states(env_state, env.get_state()))
            # env.set_state(env_state)
            # print('103', compare_states(env_state, env.get_state()))

            # 如果优化后的参数造成的误差比之前的小，则使用优化后的参数
            print("opt_error", opt_error)
            ...
            # 确保参数设置正确
            print(env.is_params_equal(init_PD_params))
    ...
    np.save("/home/aikio/Projects/BO/pos_adaptive.npy", pos)
    print("pos_adaptive.npy saved")
    np.save("/home/aikio/Projects/BO/ang_adaptive.npy", ang)
    print("ang_adaptive.npy saved")
    np.save("/home/aikio/Projects/BO/final_params_adaptive.npy", final_params_list)
    print("final_params_adaptive.npy saved")
