...
class YawControlEnv:
    ...
    def new_PD_params(self, PD_params):
        ...
        self.x_controller = PositionPID(P=Px, I=0, D=Dx)
        self.y_controller = PositionPID(P=Py, I=0, D=Dy)
        self.z_controller = PositionPID(P=Pz, I=0, D=Dz)
        self.attitude_controller = AttitudePID(P=Pa, I=0, D=Da)
