...
if __name__ == "__main__":
    ...
    for i in range(n_iterations):
        ...
        gp.set_params(alpha=noise_alpha)
    ...
    pos_error_ellipse, ang_error_ellipse = test_fixed_traj(
        X_best, length=length_traj, shape_type=0
    )
    pos_error_four, ang_error_four = test_fixed_traj(
        X_best, length=length_traj, shape_type=1
    )
    pos_error_spiral, ang_error_spiral = test_fixed_traj(
        X_best, length=length_traj, shape_type=2
    )
